...
import 'package:my24_flutter_orders/blocs/document_states.dart';
import 'package:my24_flutter_orders/models/document/form_data.dart';
...
void main() {
  ...
  test('Test fetch all documents', () async {
    ...
    const String documentData = '{"next": null, "previous": null, "count": 4, "num_pages": 1, "results": [{"id": 1, "name": "1020", "description": "test test"}]}';
    when(
  ...
  test('Test document insert', () async {
    ...
    const String documentData = '{"id": 1, "name": "1020", "description": "13948"}';
    when(
